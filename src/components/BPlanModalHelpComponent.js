				...
				<Modal.Body style={modalBodyStyle}>
					...
					<Accordion>
						...
						<Panel header="B-Plan-Dokumente betrachten" eventKey="7" bsStyle="info">
							...
							Navigationsleiste, um das zugehörige Dokument in den Anzeigebereich des Dokumentenviewers zu
							laden. Mit den Werkzeugen <Icon name="chevron-left" /> <i>"vorherige Seite"</i> und{' '}
							...
							verfahrensbegleitenden Zusatzdokumente bereits in digitaler Form vorliegen. Die
							...
							B-Pläne aus dem Kartenfenster zur Dokumentbetrachtung wechseln, wird eine ggf. bereits zuvor
							für den Dokumentenviewer geöffnete Registerkarte Ihres Browsers angesteuert.
							<br />
						</Panel>
						<Panel header="B-Pläne herunterladen" eventKey="8" bsStyle="info">
							Das Herunterladen der Dokumente zu einem B-Plan-Verfahren erfolgt aus dem Dokumentenviewer.
							Dazu finden Sie in der Werkzeugleiste zwei Möglichkeiten. Mit dem immer verfügbaren Werkzeug{' '}
							<Icon name="download" /> <i>"Dokument herunterladen (pdf)"</i> können Sie das aktuell im
							Anzeigebereich dargestellte Dokument als PDF-Datei herunterladen. Das zweite Werkzeug{' '}
							<Icon name="file-archive-o" /> <i>"alles herunterladen (zip)"</i> dient zum Download eines
							zip-Archivs mit allen Planteilen und verfahrensbegleitenden Zusatzdokumenten einschließlich
							des Info-Dokuments zu den Namenskonventionen für die Zusatzdokumente. Es lässt sich nur
							aktivieren, wenn zu dem aktuell betrachteten B-Plan mehrere Dokumente verfügbar sind.
							<br />
