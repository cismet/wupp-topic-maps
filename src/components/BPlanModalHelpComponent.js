				...
				<Modal.Body style={modalBodyStyle}>
					...
					<Accordion>
						...
						<Panel header="B-Pl&auml;ne suchen" eventKey="2" bsStyle="success">
							F&uuml;r Detailinformation und Download m&uuml;ssen Sie zun&auml;chst nach B-Pl&auml;nen
							suchen. Die Treffer werden automatisch geladen und in der Karte als transparente farbige
							Fl&auml;chen mit der B-Plan-Nummer in jeder Teilfl&auml;che dargestellt (Geltungsbereiche
							der B-Pl&auml;ne).
							<br />
						...
						<Panel header="Treffermengen durchmustern" eventKey="6" bsStyle="info">
							...
							werden Ihnen immer die Detailinformationen und Downloadlinks f&uuml;r denjenigen B-Plan
							angeboten, der gerade den Fokus hat. Mit einem einfachen Klick auf eine andere
							B-Plan-Fl&auml;che aus der Treffermenge (nicht auf die B-Plan-Nummer!) erh&auml;lt dieser
							Plan den Fokus.
							<br />
