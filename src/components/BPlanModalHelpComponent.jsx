        ...
        <Modal.Body style={modalBodyStyle}>
			  ...
			  <Accordion>
			    ...
			    <Panel header="B-Pl&auml;ne suchen" eventKey="2" bsStyle="success">
								    		F&uuml;r Detailinformation und Download m&uuml;ssen Sie zun&auml;chst nach B-Pl&auml;nen suchen. Die Treffer werden automatisch geladen und in der Karte als transparente farbige Fl&auml;chen
					              mit der B-Plan-Nummer in jeder Teilfl&auml;che dargestellt (Geltungsbereiche der B-Pl&auml;ne).<br />
					              Gr&uuml;ne Fl&auml;chen/Nummern stehen f&uuml;r rechtswirksame Verfahren, rote Fl&auml;chen/Nummern f&uuml;r laufende. Eine gr&uuml;ne Fl&auml;che mit roter Nummer bedeutet, dass es unter
					              dieser Nummer ein rechtswirksames und ein laufendes Verfahren gibt, die genau dasselbe Gebiet abdecken.
					</Panel>
			    <Panel header="Suche im Kartenausschnitt" eventKey="3" bsStyle="success">
								    		Durch Anklicken von&nbsp;<Icon name="search"/>&nbsp;suchen Sie nach B-Pl&auml;nen, die zumindest teilweise im aktuellen Kartenausschnitt liegen.<br />
			    ...
			    <Panel header="Suche &uuml;ber Adresse oder POI" eventKey="5" bsStyle="success">
					              ...
					              Nach der Auswahl eines Eintrags wird die entsprechende Position in der Karte markiert. B-Plan-Verfahren werden hier allerdings in der Umgebung dieses Punktes gesucht, in einem Kartenausschnitte der Zoomstufe 14. Sie erhalten daher in der Regel mehrere Treffer.
					</Panel>
					...
					<table style={{ width: '100%' }}>
						<tr>
							<td style={{ textAlign: 'left', verticalAlign: 'top',paddingRight: "30px"  }}>
								<span style={{ fontSize:"11px" }}><b>Hintergrundkarte</b>: in Detailma&szlig;st&auml;ben <a href="#">Amtliche Basiskarte (ABK) der Stadt Wuppertal</a>, 
								in &Uuml;bersichtsma&szlig;st&auml;ben <a href="#">WebAtlasDE &copy; GeoBasis-DE / BKG 2017</a>, jeweils &uuml;berlagert mit Geltungsbereichen 
