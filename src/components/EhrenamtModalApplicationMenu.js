                ...
                <Modal.Body style={modalBodyStyle} id="myMenu" key={this.props.uiState.applicationMenuActiveKey}>
                    ...
                    <Accordion name="help" key={"helptext"+this.props.uiState.applicationMenuActiveKey} defaultActiveKey={this.props.uiState.applicationMenuActiveKey} onSelect={()=>{
                        ...
                        <Panel header="Kompaktanleitung" eventKey="help" bsStyle="default">
														...
														<div>
														  <Link to="Datengrundlage" containerId="myMenu">     <Label bsStyle="default">Datengrundlage</Label>{' '}</Link>
														  <Link to="Kartendarstellung" containerId="myMenu">  <Label bsStyle="success">Kartendarstellung der Angebote</Label>{' '}</Link>
														  <Link to="positionieren" containerId="myMenu">      <Label bsStyle="success">In Karte positionieren</Label>{' '}</Link>
														  <Link to="selektieren" containerId="myMenu">        <Label bsStyle="info">Angebote selektieren</Label>{' '}</Link>
														  <Link to="merken" containerId="myMenu">             <Label bsStyle="info">Angebote merken</Label>{' '}</Link>
														  <Link to="Merkliste" containerId="myMenu">          <Label bsStyle="primary">Merkliste öffnen</Label>{' '}</Link>
														  <Link to="FunktionenMerkliste" containerId="myMenu"><Label bsStyle="primary">Funktionen der Merkliste</Label>{' '}</Link>
														  <Link to="filtern" containerId="myMenu">            <Label bsStyle="warning">Angebote filtern</Label>{' '}</Link>
														</div>														
                            ...
                            <h4>Datengrundlage <Link to="help" containerId="myMenu"><Icon name="arrow-circle-up"/></Link></h4>
                             <p>Diese Anwendung gibt Ihnen einen Überblick über die angebotenen Ehrenamtsstellen aus der Datenbank des Zentrums für gute Taten. Die Darstellung der Einsatzorte als Karte macht es Ihnen dabei leicht, Ehrenamtsstellen in Ihrer Nähe zu finden. Einer Ehrenamtsstelle sind im Allgemeinfall mehrere <em>Aufgabenfelder</em>, <em><em>Tätigkeiten</em></em> und  zugeordnet.</p> 
														...
														<h4>In Karte positionieren <Link to="help" containerId="myMenu"><Icon name="arrow-circle-up"/></Link></h4>
														...
														<h4>Angebote selektieren <Link to="help" containerId="myMenu"><Icon name="arrow-circle-up"/></Link></h4>
														...
														<h4>Angebote merken <Link to="help" containerId="myMenu"><Icon name="arrow-circle-up"/></Link></h4>
														...
														<h4>Merkliste öffnen <Link to="help" containerId="myMenu"><Icon name="arrow-circle-up"/></Link></h4>
														...
														<h4>Funktionen der Merkliste <Link to="help" containerId="myMenu"><Icon name="arrow-circle-up"/></Link></h4>
														 ...
														 <ul>
															 ...
															 <li>Mit <font color="#FF0000"><Icon name="plus-square"/></font> können Sie das zugehörige Angebot aus Ihrer Merkliste entfernen.</li>
														 ...
														 <ul>
															 ...
															 <ul>
															 <li>Zentrale Funktion ist dabei <Icon name="clone"/> Link kopieren: hiermit kopieren sie einen Link in die Zwischenablage, der das Infoportal Ehrenamt mit dem Inhalt Ihrer Merkliste öffnet. Der Inhalt Ihrer Merkliste wird als Liste über den Parameter „cart“ übergeben. Wenn ein Nutzer, der bereits eigene Angebote in seiner Merkliste hat, diesen Link anklickt, werden die übergebenen Angebote an seine Merkliste angehängt.</li>
