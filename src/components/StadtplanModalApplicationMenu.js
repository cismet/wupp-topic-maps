        ...
        >
                        ...
                        <table border={0}>
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <a onClick={() => this.changePoiSymbolSize(45)}>
                                  <img alt="minimal" src="images/poi.45.png" />
                                </a>
                              </td>
                            </tr>
          ...
          >
            <Panel header="Kompaktanleitung" eventKey="help" bsStyle="default">
              ...
              <p>
                Der Online-Stadtplan der Stadt Wuppertal basiert auf dem Stadtplanwerk 2.0 des
                Regionalverbandes Ruhrgebiet. Dieses innovative Kartenwerk kombiniert das
              ...
              <p>
                ...
                kleineren Symbole für die konkreten Einzel-POI zerlegt. Ab einer bestimmten
                Maßstabsstufe (Zoomstufe 12) führt ein weiterer Klick dazu, dass eine
              ...
              <p>
                ...
                seine Bezeichnung anzeigen zu lassen. Ein Klick auf das zugehörige POI-Symbol setzt
                den Fokus auf diesen POI. Er wird dann blau hinterlegt und die zugehörigen
                Informationen (Bezeichnung, Info-Text und ggf. Adresse) werden in der Info-Box
                ...
                angezeigt: <Icon name="link" /> Internet, <Icon name="envelope-square" /> E-Mail und{" "}
                <Icon name="phone" /> Telefon.
              </p>
              <p>
                Wenn Sie noch nicht aktiv einen bestimmten POI im aktuellen Kartenausschnitt
                selektiert haben, wird der Fokus automatisch auf den nördlichsten POI gesetzt. Mit
                den Funktionen <img alt="Cluster" src="images/vorher_treffer.png" /> vorheriger
                Treffer und <img alt="Cluster" src="images/nachher_treffer.png" /> nächster Treffer
                können Sie in nördlicher bzw. südlicher Richtung alle aktuell im Kartenfenster
                angezeigten POI durchmustern.
              </p>
              <p>
                Zu einigen POI bieten wir Ihnen Fotos oder Fotoserien des bekannten Wuppertaler
                Fotographen Peter Krämer an. Sie finden dann ein Vorschaubild direkt über der
                Info-Box. Klicken Sie auf das Vorschaubild, um einen Bildbetrachter ("Leuchtkasten")
                mit dem Foto&nbsp;/&nbsp;der Fotoserie zu öffnen. Aus dem Bildbetrachter gelangen
                Sie über einen Link im Fußbereich auch zur Foto-Anwendung von Peter Krämer.
              </p>
              ...
              <p>
                ...
                Stadtteils (Stadtbezirk oder Quartier), einer Adresse, eines Straßennamens oder
              ...
              <p>
                ...
                Themenfelder an. Wählen Sie z. B. mit <Icon name="thumbs-up" /> ausschließlich das
                Thema "<em>Kultur</em>" aus. Als Vorschau wird Ihnen ein Tortendiagramm angezeigt,
                das die Anzahl der zugehörigen POI und deren Verteilung auf die Themen-Kombinationen
                (hier "<em>Kultur, Gesellschaft</em>" und "<em>Kultur, Freizeit</em>
                ") anzeigt. Bewegen Sie dazu den Mauszeiger auf eines der farbigen Segmente des
                Tortendiagramms. (Bei einem Gerät mit Touchscreen tippen Sie auf eines der farbigen
                Segmente.)
              </p>
              <p>
              ...
              <p>
                ...
                beieinander liegende POI maßstabsabhängig zu einem Punktsymbol zusammengefasst
              ...
              <p>
                Die Nacht-Karte erzeugt einen deutlicheren Kontrast mit den farbigen POI-Symbolen,
                die unterschiedlichen Flächennutzungen lassen sich aber nicht so gut unterscheiden
                wie in der Tag-Karte.
              </p>
              ...
              <p>
                ...
                erhalten. (Es sei denn, Sie löschen den Browser-Verlauf einschließlich der
                gehosteten App-Daten.) Damit können Sie mit wenigen Klicks aus unserem
                Online-Stadtplan einen dauerhaft für Sie optimierten Themenstadtplan machen.
              </p>
            </Panel>
          </Accordion>
        </Modal.Body>
...
const StadtplanModalApplicationMenu = connect(
  mapStateToProps,
  mapDispatchToProps
