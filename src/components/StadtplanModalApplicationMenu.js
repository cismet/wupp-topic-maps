                ...
                <Modal.Body style={modalBodyStyle} id="myMenu" key={this.props.uiState.applicationMenuActiveKey}>
                    ...
                    <Accordion name="help" key={"helptext"+this.props.uiState.applicationMenuActiveKey} defaultActiveKey={this.props.uiState.applicationMenuActiveKey} onSelect={()=>{
                        ...
                        <Panel header="Kompaktanleitung" eventKey="help" bsStyle="default">
														...
														<div>
														  <Link to="Datengrundlage" containerId="myMenu" style={{textDecoration: 'none'}}>     <Label bsStyle="warning">Datengrundlage</Label>{' '}</Link>
														  <Link to="KartendarstellungPOI" containerId="myMenu" style={{textDecoration: 'none'}}>     <Label bsStyle="warning">Kartendarstellung der POI</Label>{' '}</Link>
														  <Link to="POIauswahluabfragen" containerId="myMenu" style={{textDecoration: 'none'}}>     <Label bsStyle="default">POI auswählen und abfragen</Label>{' '}</Link>
                            ...
                            <h4>Datengrundlage <Link to="help" containerId="myMenu" style={{ color: '#00000044'}}><Icon name="arrow-circle-up"/></Link></h4>
                             <p>Der Online-Stadtplan der Stadt Wuppertal basiert auf dem Stadtplanwerk 2.0 des Regionalverbandes Ruhrgebiet. Dieses innovative Kartenwerk kombiniert das Straßennetz der OpenStreetMap mit den Gebäuden und Flächennutzungen aus dem Fachverfahren ALKIS des Liegenschaftskatasters. Das Stadtplanwerk 2.0 wird wöchentlich in einem automatischen Prozess aktualisiert. Zusätzlich nutzt der Online-Stadtplan den Datensatz <a href="https://offenedaten-wuppertal.de/dataset/interessante-orte-wuppertal-poi" target="_opendata">Interessante Orte Wuppertal (POI)</a> aus dem Open-Data-Angebot der Stadt Wuppertal.</p> 
                            ...
                            <h4>POI auswählen und abfragen <Link to="help" containerId="myMenu" style={{ color: '#00000044'}}><Icon name="arrow-circle-up"/></Link></h4>
                             <p>Bewegen Sie den Mauszeiger im Kartenfenster auf einen konkreten Einzel-POI, um sich seine Bezeichnung anzeigen zu lassen. Ein Klick auf das zugehörige POI-Symbol setzt den Fokus auf diesen POI. Er wird dann blau hinterlegt und die zugehörigen Informationen (Bezeichnung, Info-Text und ggf. Adresse) werden in der Info-Box (unten rechts) angezeigt. (Auf einem Tablet-PC wird der Fokus durch das erste Antippen des Angebots gesetzt, das zweite Antippen blendet die Bezeichnung ein.) Außerdem werden Ihnen in der Info-Box weiterführende (Kommunikations-) Links zum POI angezeigt: <Icon name="link"/> Internet, <Icon name="envelope-square"/> E-Mail und <Icon name="phone"/> Telefon.</p>
                             <p>Wenn Sie noch nicht aktiv einen bestimmten POI im aktuellen Kartenausschnitt selektiert haben, wird der Fokus automatisch auf den nördlichsten POI gesetzt. Mit den Funktionen <img alt="Cluster" src="images/vorher_treffer.png" /> vorheriger Treffer und <img alt="Cluster" src="images/nachher_treffer.png" /> nächster Treffer können Sie in nördlicher bzw. südlicher Richtung alle aktuell im Kartenfenster angezeigten POI durchmustern.</p>
                             <p>Zu einigen POI bieten wir Ihnen Fotos oder Fotoserien des bekannten Wuppertaler Fotographen Peter Krämer an. Sie finden dann ein Vorschaubild direkt über der Info-Box. Klicken Sie auf das Vorschaubild, um einen Bildbetrachter ("Leuchtkasten") mit dem Foto&nbsp;/&nbsp;der Fotoserie zu öffnen. Aus dem Bildbetrachter gelangen Sie über einen Link im Fußbereich auch zur Foto-Anwendung von Peter Krämer.</p> 
                            ...
                            <h4>In Karte positionieren <Link to="help" containerId="myMenu" style={{ color: '#00000044'}}><Icon name="arrow-circle-up"/></Link></h4>
                             ...
                             <p>Durch Anklicken des Werkzeugs <Icon name="times"/> links neben dem Eingabefeld können Sie die Suche zurücksetzen (Entfernung von Marker bzw. Abdunklung, Löschen des Textes im Eingabefeld).</p> 
                            ...
                            <div name="MeinThemenstadtplan"><br /></div>
														<h4>Mein Themenstadtplan <Link to="help" containerId="myMenu" style={{ color: '#00000044'}}><Icon name="arrow-circle-up"/></Link></h4>
														 <p>Unter „<strong>Mein Themenstadtplan</strong>“ können Sie im Anwendungsmenü <Icon name="bars"/> auswählen, welche POI-Kategorien in der Karte dargestellt werden. Über die Schaltfläche <img alt="Cluster" src="images/sf_keinethemenausw.png" /> können Sie die POI vollständig ausblenden - auch die Info-Box wird dann nicht mehr angezeigt.</p>
                             <p>Zur Filterung der POI-Kategorien bieten wir Ihnen die oben beschriebenen Themenfelder an. Wählen Sie z. B. mit <Icon name="thumbs-up"/> ausschließlich das Thema "<em>Kultur</em>" aus. Als Vorschau wird Ihnen ein Tortendiagramm angezeigt, das die Anzahl der zugehörigen POI und deren Verteilung auf die Themen-Kombinationen (hier "<em>Kultur, Gesellschaft</em>" und "<em>Kultur, Freizeit</em>") anzeigt. Bewegen Sie dazu den Mauszeiger auf eines der farbigen Segmente des Tortendiagramms. (Bei einem Gerät mit Touchscreen tippen Sie auf eines der farbigen Segmente.)</p>
                             <p>Mit <Icon name="thumbs-down"/> können Sie die POI, die dem entsprechenden Thema zugeordnet sind, ausblenden und dadurch die Treffermenge reduzieren. Schließen Sie jetzt z. B. das Thema „<em>Gesellschaft</em>“ aus. Im Tortendiagramm werden Ihnen dann nur noch die POI mit der Themen-Kombination "<em>Kultur, Freizeit</em>" angezeigt (Theater, Museen etc.). Die POI mit der Kombination "<em>Kultur, Gesellschaft</em>" (Standorte von Verlagen und anderen Medienunternehmungen) wurden dagegen entfernt.</p>
														...
														<h4>Einstellungen <Link to="help" containerId="myMenu" style={{ color: '#00000044'}}><Icon name="arrow-circle-up"/></Link></h4>
														 <p>Unter "<strong>Einstellungen</strong>" können Sie im Anwendungsmenü <Icon name="bars"/> festlegen, wie die POI und die Hintergrundkarte angezeigt werden sollen. Zu den POI können Sie auswählen, ob Ihre unter "<strong>Mein Themenstadtplan</strong>" festgelegte Lebenslagen-Filterung in einer Titelzeile ausgeprägt wird oder nicht. Weiter können Sie festlegen, ob räumlich nah beieinander liegende POI maßstabsabhängig zu einem Punktsymbol zusammengefasst werden oder nicht. Unter "<em><strong>Symbolgröße</strong></em>" können Sie in Abhängigkeit von Ihrer Bildschirmauflösung und Ihrem Sehvermögen auswählen, ob die POI mit kleinen (25 Pixel), mittleren (35 Pixel) oder großen (45 Pixel) Symbolen angezeigt werden.</p>
