...
const BaederModalMenuHelpSection=({
    uiState,
    uiStateActions
})=> {
    return (
      ...
      <p>
        Die <strong>Bäder Karte Wuppertal</strong> benutzt als Kartengrundlage das Stadtplanwerk 2.0
        ...
        Prozess aktualisiert. Zusätzlich nutzt die Bäder Karte den Datensatz{" "}
        <a
        ...
        des Stadtbetriebs R102 aus dem Open-Data-Angebot der
        Stadt Wuppertal.
      </p>
