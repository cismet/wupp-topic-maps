      ...
      sectionContent={
        <div>
          <p>
            ...
            Sie den Anfang eines Stra&szlig;ennamens oder eines interessanten Ortes (auch Point of
          ...
          <p>
            ...
            &nbsp;POI, die&nbsp;
            <Icon name="tags" />
            &nbsp;alternative Bezeichnung eines POI oder eine <Icon name="graduation-cap" /> Schule
            handlet. (Probieren Sie es mal mit der Eingabe "Sankt".)
          </p>
          <p>
          ...
          <p>
            Auch nach einer Positionierung in der Karte über Adresse oder POI können Sie die Suche
            mit dem Werkzeug <Icon name="times" /> links neben dem Eingabefeld zurücksetzen (s.{' '}
