...
const GenericHelpTextForMyLocation = () => {
  return (
    <p>
      ...
      mit einem blauen Kreissymbol <img alt="Cluster" src="images/MeinStandpunktMarker.jpg" /> in
      ...
      und Tablet-PC's sind i. d. R. mit einer GPS-Antenne ausgestattet, so dass Sie bei diesen
