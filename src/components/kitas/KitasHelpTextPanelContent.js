...
const KitasHelpTextPanel = () => {
  return (
    <div>
      ...
      <p>
        Der <strong>Kita-Finder Wuppertal</strong> benutzt als Kartengrundlage das Stadtplanwerk 2.0
      ...
      <p>
        ...
        Smartphones und Tablet-PC's sind i. d. R. mit einer GPS-Antenne ausgestattet, so dass Sie
        bei diesen Geräten eine Positionsgenauigkeit in der Größenordnung von 10 Metern erwarten
        können. Die Markierung Ihrer Position wird laufend automatisch aktualisiert. Ein weiterer
        Klick auf "Mein Standort" schaltet die Anzeige Ihrer Position wieder ab.
      </p>
      ...
      <p>
        ...
        <strong>Filtern</strong>" und in dem Tortendiagramm, das Sie rechts neben oder unter den
        Filteroptionen finden, ausgewertet. Die Titelzeile zeigt die Gesamtanzahl der Kitas, die den
        von Ihnen gesetzten Filterbedingungen entsprechen. Das Tortendiagramm zeigt zusätzlich die
      ...
      <p>
        ...
        festlegen, ob räumlich nah beieinander liegende Kitas maßstabsabhängig zu einem Punktsymbol
