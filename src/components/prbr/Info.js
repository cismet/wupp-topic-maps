  ...
  return (
    <InfoBox
      ...
      currentlyShownCountLabel={`${featureCollection.length} ${
        featureCollection.length === 1 ? 'Anlage' : 'Anlagen'
      } angezeigt`}
      ...
      noCurrentFeatureContent={
        <div style={{ marginRight: 9 }}>
          <p>
            Für mehr Anlagen Ansicht mit <Icon name="minus-square" /> verkleinern oder mit
            untenstehendem Link alle Treffer der aktuellen Filterung anzeigen. Ggf.
