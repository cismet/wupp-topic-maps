			...
			sectionContent={
				<div>
					...
					<p>
						...
						nur noch der Typ der Anlage (Park + Ride oder Bike + Ride), ihr Name und das{' '}
						<FontAwesomeIcon icon={faInfoCircle} />-Symbol angezeigt werden - nützlich
					...
					<p>
						Mit den Optionen unter "<b>Umweltzonen</b>" können Sie die Kartenanzeige auf
						Anlagen innerhalb oder außerhalb der beiden Wuppertaler Umweltzonen
						beschränken. Unter "<b>Art der Anlage</b>" können Sie die Anzeige auf P+R-
						oder B+R-Anlagen eingrenzen.
					</p>
					<p>
						Ihre Einstellungen werden direkt in der blauen Titelzeile des Bereichs
						"Filter" und in dem Donut-Diagramm, das Sie rechts neben oder unter den
					...
					<p>
						Zu den Anlagen können Sie unter "P+R / B+R Einstellungen" auswählen, ob Ihre
						unter "Filtern" festgelegten Filterbedingungen in einer Titelzeile
						ausgeprägt werden oder nicht. Weiter können Sie dort festlegen, ob räumlich
						nah beieinander liegende Anlagen maßstabsabhängig zu einem Punktsymbol
						zusammengefasst werden oder nicht. Unter "Symbolgröße" können Sie in
						Abhängigkeit von Ihrer Bildschirmauflösung und Ihrem Sehvermögen auswählen,
						ob die P+R- und B+R-Anlagen mit kleinen (35 Pixel), mittleren (45 Pixel)
						oder großen (55 Pixel) Symbolen angezeigt werden.
					</p>
					<p>
						Unter "<b>Hintergrundkarte</b>" können Sie auswählen, ob Sie die
						standardmäßig aktivierte farbige Hintergrundkarte verwenden möchten
						("Stadtplan (Tag)") oder lieber eine invertierte Graustufenkarte ("Stadtplan
						(Nacht)"), zu der uns die von vielen PKW-Navis bei Dunkelheit eingesetzte
						Darstellungsweise inspiriert hat. <b>Hinweis</b>: Der Stadtplan (Nacht) wird
						Ihnen nur angeboten, wenn Ihr Browser CSS3-Filtereffekte unterstützt, also
						z. B. nicht beim Microsoft Internet Explorer. Die Nacht-Karte erzeugt einen
						...
						Kontrollkästchen "Umweltzonen" steuern, ob die Umweltzonen dargestellt
						werden oder nicht. Die Umweltzonen lassen sich mit allen drei
						...
						"innerhalb/außerhalb Umweltzone" verwenden.
					</p>
