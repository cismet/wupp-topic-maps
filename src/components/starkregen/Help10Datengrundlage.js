  ...
  return (
    <GenericModalMenuSection
      ...
      sectionContent={
        <div>
          <p>
            Die Starkregengefahrenkarte Wuppertal stellt in einem 1m x 1m Raster maximale
            Wasserstände dar, die im Verlauf von simulierten Starkregenereignissen auftreten. Die
            Wasserstände werden dazu in vier Stufen (größer als 10, 30, 50 und 100 cm)
            klassifiziert, die in der Karte durch unterschiedliche Einfärbung der Rasterzellen (von
            blau nach rot) dargestellt werden. Die Simulationsberechnungen wurden im Auftrag der
          ...
          <ul>
            ...
            <li>
              ...
              hergestellt durch Aero West GmbH/Dortmund, Bodenauflösung 10 cm. (True Orthophoto: Aus
