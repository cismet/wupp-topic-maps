			...
			sectionContent={
				<div>
					<p>
						...
						Simulation für eine jede 1m x 1m Rasterzelle berechnet worden ist. Anstelle der Schaltfläche
						erscheint in diesem Modus das Anzeigefeld "Maximaler Wasserstand", zunächst mit einem kurzen
						...
						"> 150 cm" angezeigt. Wenn Sie nach der Abfrage eines maximalen Wasserstandes eine andere
						Simulation auswählen, wird der angezeigte Zellwert automatisch aktualisiert. So können Sie für
						...
						wird das Anzeigefeld auf seinen Startzustand zurückgesetzt. Mit einem Klick auf das <Icon name="close" /> Symbol
						rechts oben im Anzeigefeld beenden Sie den Abfragemodus.
					</p>
				</div>
			}
		/>
