...
export class Container_ extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        {title}
        {isSecondaryInfoBoxVisible(this.props.emob) === true && selectedFeature !== undefined && (
          <SecondaryInfoModal
        ...
        <TopicMap
          ...
          locatorControl
          gazetteerSearchBox
          gazetteerTopicsList={['emob', 'pois', 'kitas', 'quartiere', 'bezirke', 'adressen']}
          ...
          backgroundlayers={this.props.match.params.layers || reduxBackground || 'wupp-plan-live'}
          ...
          modalMenu={
            <EMOBModalMenu
              ...
              featureCollectionObjectsCount={getEMOBFeatureCollection(this.props.emob).length}
              steckertypes={this.props.emob.local.steckertypes}
            />
          }
          clusteringEnabled={
