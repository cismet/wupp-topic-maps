...
export class Container_ extends React.Component {
  ...
  render() {
    ...
    if (this.state.mode === 'arbeitskarte') {
      titleContent = (
        <div>
          <b>Arbeitskarte: </b> fortgeschriebene Hauptnutzungen (informeller FNP-Auszug)
        ...
        <div>
          ...
          <div style={{ float: 'right', paddingRight: 10 }}>
            <a href={'/#/fnp/arbeitskarte' + this.props.routing.location.search}>
              <FontAwesomeIcon icon={switchIcon} style={{ marginRight: 5 }} /> zur Arbeitskarte
            </a>
          </div>
        </div>
      );
    ...
    if (
      ...
      selectedFeature = this.props.mapping.featureCollection[this.props.mapping.selectedIndex];
    ...
    return (
      <div>
        ...
        <TopicMap
          ...
          backgroundlayers={
            'nothing' || this.props.match.params.layers || reduxBackground || 'wupp-plan-live'
          }
          dataLoader={[
          ...
          modalMenu={
            <FNPModalHelp uiState={this.props.uiState} uiStateActions={this.props.uiStateActions} />
          }
        ...
        >
                ...
                let mailToHref =
                  ...
                  encodeURI(
                    `Sehr geehrte Damen und Herren,${br}${br}` +
                      `zur offenliegenden ${selectedFeature.properties.name}. FNP-Änderung äußere ich mich ` +
                      `wie folgt:${br}` +
                      `${br}${br}` +
          ...
          {aevVisible === true && this.isRechtsplan() && (
