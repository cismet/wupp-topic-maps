...
const Comp = () => {
  const hashChange = (event) => {
    ...
    if (hash.includes(keyword + '=')) {
      ...
      var targetUrl = hash.substring(hash.indexOf('rc=[') + keyword.length + 2, hash.indexOf(']'));
  ...
  return (
    <div style={{ margin: '100px' }}>
      ...
      <p>
        <iframe
          title="test"
          src_="#/bplaene?allowRemoteControl=true&lat=51.26956716943953&lng=7.186829522224084&zoom=8"
          src="#/baeder?allowRemoteControl=true&lat=51.26956716943953&lng=7.186829522224084&zoom=8"
