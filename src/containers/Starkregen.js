...
export class Starkregen_ extends React.Component {
  ...
  componentDidUpdate() {
    if (
      ...
      this.props.routingActions.push('/starkregen/hoehen' + this.props.routing.location.search);
  ...
  render() {
    ...
    if (this.props.starkregen.displayMode === starkregenConstants.SHOW_HEIGHTS) {
      titleContent = (
        <div>
          <b>Starkregengefahrenkarte: </b> max. Wasserstände
          <div style={{ float: 'right', paddingRight: 10 }}>
            <a href={'/#/starkregen/fliessgeschwindigkeiten' + this.props.routing.location.search}>
              <FontAwesomeIcon icon={switchIcon} style={{ marginRight: 5 }} />
      ...
      titleContent = (
        <div>
          <b>Starkregengefahrenkarte: </b> max. Fließgeschwindigkeiten
          <div style={{ float: 'right', paddingRight: 10 }}>
    ...
    return (
      <div>
        ...
        <TopicMap
          ...
          modalMenu={
            <HelpAndInfo uiState={this.props.uiState} uiStateActions={this.props.uiStateActions} />
          }
          cursor={cursor}
        ...
        >
          ...
          {this.props.starkregen.modelLayerProblem && (
            ...
            >
              <h5>
                <Icon name="exclamation-circle" /> Es liegt eine Störung vor. Momentan können leider
                keine Modellinformationen angezeigt werden. Bitte versuchen Sie es später noch
                einmal.
              </h5>
