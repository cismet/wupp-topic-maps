...
export class TopicMap_ extends React.Component {
	constructor(props, context) {
		...
		this.props.mappingActions.setBoundingBoxChangedTrigger((bbox) => this.props.refreshFeatureCollection(bbox));
	}
	componentWillMount() {
	...
	gotoHome() {
		this.leafletRoutedMap.leafletMap.leafletElement.setView(this.props.home.center, this.props.home.zoom);
	}
